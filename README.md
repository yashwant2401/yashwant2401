...
Scalable backend systems using **Python, FastAPI, SQLAlchemy**, rider operations & analytics platforms.

🤝 **Open to Collaborate On**
Backend APIs, system optimization, distributed systems & open‑source Python/FastAPI projects.

🌱 **Currently Learning**
System Design, **Kafka**, **Redis**, **Microservices Architecture**.

💬 **Ask Me About**
Python, FastAPI, REST APIs, SQL, Kafka basics & **.NET → Python migrations**.

⚡ **Fun Fact**
I love simplifying complex legacy systems into clean, modern architectures 🚀
...
<a href="https://instagram.com/yashwant_badhe_patil"><img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"/></a> <a href="https://www.linkedin.com/in/yashwant-badhe-a34788235"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/></a> <a href="mailto:yashwantbadhe68@gmail.com"><img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white"/></a>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,fastapi,postgres,mysql,redis,kafka,docker,kubernetes,aws,nginx,git,github,linux" />
</p>

<details>
<summary><b>✨ Full Tech Arsenal</b></summary>
<br>
...
<p align="center">
  <a href="https://github.com/Yashwantbadhe2401">
...
<p align="center">
  <b>✨ More projects focus on scalable APIs, FastAPI microservices, SQL optimization & real-time systems</b>
</p>

---

## 🎥 Backend Project Previews (GIFs)
...
<p align="center">
  <i>FastAPI • JWT Auth • Kafka Events • SQL Analytics • Dockerized Services</i>
</p>

---

## 🧩 System Design & Kafka Architecture (Clean Diagram View)

<p align="center">
  <b>📐 Rider Operations – Event‑Driven Architecture (Interview‑Ready)</b>
</p>
...
* Explains scalability in simple terms
* Easy to narrate in interviews & design rounds
* Matches real **delivery / rider platforms**
...
<p align="center">
  🌑 Dark Theme Optimized &nbsp;&nbsp;|&nbsp;&nbsp; 🌕 Light Theme Friendly
</p>

> GitHub automatically adapts this profile to your selected theme.
...
* 🔹 Async Python, Background Tasks & WebSockets
* 🔹 Kafka Producers / Consumers
* 🔹 Redis for caching & rate limiting
* 🔹 SQL performance tuning & stored procedures
* 🔹 Docker & Kubernetes deployments
* 🔹 Legacy **.NET → Python** system migrations
...
<p align="center">
  ## ⚡ Performance & Scalability Metrics (Production-Oriented)
...
> *A concise snapshot of real-world backend systems I’ve built and scaled*

## 🚖 Rider Operations & Analytics Platform

**Role:** Backend Engineer (Python / FastAPI)

### Problem

Legacy synchronous APIs caused slow rider onboarding, tight coupling, and poor analytics scalability.
...
`Python` `FastAPI` `Kafka` `Redis` `SQL Server` `PostgreSQL` `Docker`
